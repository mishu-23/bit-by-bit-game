...
public class PowerBitPlayerController : MonoBehaviour
{
    ...
    private void ProcessRollingInput(float moveInput, float speedMultiplier)
    {
        ...
        // No damping - let Unity's natural physics handle deceleration
    }
    ...
    private float GetMovementSpeedMultiplier()
    {
        ...
        int maxBits = gridSize * gridSize; // Total grid capacity
    ...
    private void Shoot()
    {
        ...
        // Use the projectile spawner's rarity system to determine projectile type
        projectileSpawner.SpawnProjectile();
        
        LogDebugInfo("Shot fired - rarity determined by ProjectileSpawner");
    }
    
    // Removed - no longer needed since we only shoot default projectiles
